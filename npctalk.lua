...
SlashCmdList.NPCTALK = function(msg)
	...
	elseif cmd:lower() == "clear" then
		...
		print("|cffaaaaaa/talk|r |cff00c2ffmessage|r: lets your target speak the message.")
